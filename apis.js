...
import { updatePersonalStickerFactory } from "./apis/updatePersonalSticker.js";
...
import { rejectGroupCallFactory } from "./apis/rejectGroupCall.js";
...
import { sendForwardFactory } from "./apis/sendForward.js";
...
export class API {
    constructor(ctx, zpwServiceMap, wsUrls) {
        ...
        this.updatePersonalSticker = updatePersonalStickerFactory(ctx, this);
        ...
        this.blockUsersInGroup = blockUsersInGroupFactory(this);
        this.unblockUsersInGroup = unblockUsersInGroupFactory(this);
        this.changeGroupLink = changeGroupLinkFactory(this);
        this.getGroupInfoByLink = getInfoGroupByLinkFactory(this);
        this.getBlockedUsersInGroup = getBlockedUsersInGroupFactory(this);
        ...
        this.rejectGroupCall = rejectGroupCallFactory(ctx, this);
        ...
        this.sendForward = sendForwardFactory(this);
        this.sendMessageForward = sendMessageForwardFactory(this);
        this.sendTodo = sendToDoFactory(this);
        // Backward-compatible aliases (tên cũ → tên mới)
        this.changeGroupSetting       = this.updateGroupSettings;
        this.getGroupMembers          = this.getGroupMembersInfo;
        this.getGroupMembersJoinRequest = this.getPendingGroupMembers;
        this.handleGroupPendingMembers  = this.reviewPendingMemberRequest;
        this.joinGroupByLink          = this.joinGroupLink;
        this.joinGroup                = this.joinGroupLink;
        this.undoMessage              = this.undo;
        this.blockUsers               = this.blockUsersInGroup;
        this.unblockUsers             = this.unblockUsersInGroup;
        this.sendVoiceUnified         = this.sendVoice;
    }
}
